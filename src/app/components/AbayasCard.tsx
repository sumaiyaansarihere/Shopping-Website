...
const AbayasCard: React.FC<PropsType> = ({
  img,
  title,
  desc = "",
  ratings = 0,
  ...
  return (
    <div className="product-card px-4 border bg-white border-gray-700 rounded-xl max-w-[400px]">
      ...
      <div className="space-y-2 py-2">
        ...
        {/* Description */}
        <p className="text-gray-600 max-w-[150px] truncate">{desc}</p>
        {/* Ratings */}
